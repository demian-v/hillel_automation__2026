...
COUNTRIES = ["India", "USA", "UK", "Canada", "Australia", "Germany", "France", "Japan", "Brazil", "South Africa"]

def get_country(first_name = None):
	if first_name != None:
		nameFile = csv.reader(open(full_path('data.csv'), 'r'))
		if not any(data[0] == first_name for data in nameFile):
